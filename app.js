window.onload = function () {
  ...
  function init() {
    ...
    canvas.style.border = "30px solid #1A1818";
    canvas.style.margin = "45px auto";
    canvas.style.display = "block";
    canvas.style.backgroundColor = "#FBF301";
  ...
  function Apple(position) {
    ...
    this.isOnSnake = function (snakeToCheck) {
      ...
      for (var i = 0; i < snakeToCheck.body.length; i++) {
        if (
          this.position[0] === snakeToCheck.body[i][1] &&
          this.position[0] === snakeToCheck.body[i][1]
        ) {
          isOnSnake = true;
        }
